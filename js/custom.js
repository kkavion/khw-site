...
function bid1()
{
	...
	document.forms["bidnwin"]["Bid Number"].value = "BD #101 - November 2022";
}
function bid2()
{
	document.forms["bidnwin"]["Property"].value = "The Amaya Resort";
	document.forms["bidnwin"]["Bid Number"].value = "BD #102 - November 2022";
}
function bid3()
{
	document.forms["bidnwin"]["Property"].value = "The Ffort Raichak";
	document.forms["bidnwin"]["Bid Number"].value = "BD #103 - November 2022";
}
function bid4()
{
	document.forms["bidnwin"]["Property"].value = "Fortune Park Panchawati";
	document.forms["bidnwin"]["Bid Number"].value = "BD #104 - November 2022";
}
function bid5()
{
	document.forms["bidnwin"]["Property"].value = "The Rajbari Bawali";
	document.forms["bidnwin"]["Bid Number"].value = "BD #105 - November 2022";
}
function bid6()
{
	document.forms["bidnwin"]["Property"].value = "Ibiza The Fern Resort & Spa";
	document.forms["bidnwin"]["Bid Number"].value = "BD #106 - November 2022";
}